...
//R. Por causa do transform: translateY(-20px); aplicado a classe tech no css
...
function addText(event) {
    let alvo = document.querySelectorAll('.tech')
    for (let i = 0; i < alvo.length; i += 1){
        alvo[i].innerText = event.target.value
    }
}
...
myWebpage.addEventListener('dblclick',redirects)
function redirects(event) {
    window.open("https://github.com/joao-gui-marcos")
}
